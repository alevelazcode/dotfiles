return {
  ...
  -- Indent blankline (rainbow indents)
  {
    ...
    config = function()
      ...
      hooks.register(hooks.type.HIGHLIGHT_SETUP, function()
        vim.api.nvim_set_hl(0, "RainbowRed", { fg = "#ff6e5e" })
        vim.api.nvim_set_hl(0, "RainbowYellow", { fg = "#f1ff5e" })
        vim.api.nvim_set_hl(0, "RainbowBlue", { fg = "#5ea1ff" })
        vim.api.nvim_set_hl(0, "RainbowOrange", { fg = "#ffbd5e" })
        vim.api.nvim_set_hl(0, "RainbowGreen", { fg = "#5eff6c" })
        vim.api.nvim_set_hl(0, "RainbowViolet", { fg = "#bd5eff" })
        vim.api.nvim_set_hl(0, "RainbowCyan", { fg = "#5ef1ff" })
      end)
  ...
  -- nvim-dap - Debug Adapter Protocol client
  {
    ...
    config = function()
      ...
      -- Highlight groups for breakpoints (cyberdream palette)
      vim.api.nvim_set_hl(0, "DapBreakpoint", { fg = "#ff6e5e" })
      vim.api.nvim_set_hl(0, "DapBreakpointCondition", { fg = "#f1ff5e" })
      vim.api.nvim_set_hl(0, "DapLogPoint", { fg = "#5ea1ff" })
      vim.api.nvim_set_hl(0, "DapStopped", { fg = "#5eff6c", bg = "#1e2124" })
      vim.api.nvim_set_hl(0, "DapBreakpointRejected", { fg = "#7b8496" })
