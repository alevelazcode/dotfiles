...
# Requires yabai >= 7.1.25: cross-space moves work with SIP enabled on Tahoe
# (restored in v7.1.25, 2026-05-08). On older builds these rules are no-ops.
...
# 9  personal chat
# WhatsApp's window name carries a leading U+200E (LTR mark); match by suffix.
